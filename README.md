...
**الحالة:** المراحل 1 و2 و3 ✅ مكتملة — راجع [`docs/PROGRESS.md`](docs/PROGRESS.md) للتقدّم التفصيلي.

> 🚀 **أول مرة هنا؟** اتبع [`docs/TESTING-GUIDE.md`](docs/TESTING-GUIDE.md) — دليل
> مُختبَر خطوة بخطوة (**ويندوز + لينكس/ماك**) من التثبيت إلى أول مقطع في أقل من 3 دقائق.
>
> اختصار التشغيل: **`.\arc <أمر>`** في PowerShell (أو `arc <أمر>` في cmd)،
> و`./arc.sh <أمر>` على لينكس/ماك.
